...
# Stationary, same skeleton as Spitting Bloom — fires fire_bolt.tscn
# (burns on hit) instead of the generic projectile.tscn.
const FIRE_BOLT_SCENE = preload("res://fire_bolt.tscn")
const VISUAL_COLOR: Color = Color(0.8, 0.3, 0.1, 1.0)
